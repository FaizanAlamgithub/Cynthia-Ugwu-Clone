...
function expandCursor() {
  window.addEventListener("mousemove", (e) => {
    ...
    if (
      ...
      document.querySelector(".cursor").style.width = `14px`;
      document.querySelector(".cursor").style.height = `14px`;
    ...
    } else if (targetElement.tagName.toLowerCase() === "span") {
      document.querySelector(".cursor").style.width = `45px`;
      document.querySelector(".cursor").style.height = `45px`;
      document.querySelector(".cursor").style.left = `-10px`;
      document.querySelector(".cursor").style.top = `-10px`;
      document.querySelector(".cursor").style.mixBlendMode = `difference`;
    } else {
...
menuBtn.addEventListener("click", function () {
  if (window.innerWidth >= 769) {
    console.log("hello");
    if (
      navLinks.classList.contains("display-none") &&
      !menuBtn.classList.contains("display-none")
    ) {
